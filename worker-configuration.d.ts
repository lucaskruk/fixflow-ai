/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e958b8fa7771f90ce42daa92a85b0ca9)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	FIXFLOW_AUTH_USERNAME: string;
	FIXFLOW_AUTH_PASSWORD_HASH: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIXFLOW_AUTH_USERNAME" | "FIXFLOW_AUTH_PASSWORD_HASH">> {}
}
